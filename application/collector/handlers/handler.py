from application.collector.handlers.handler_jira import HandlerJira
from application.collector.handlers.handler_p4 import HandlerP4
from application.collector.handlers.handler_plm import HandlerPlm
from application.collector.handlers.handler_retriever import HandlerRetriver
from application.common.auth import get_credentials
